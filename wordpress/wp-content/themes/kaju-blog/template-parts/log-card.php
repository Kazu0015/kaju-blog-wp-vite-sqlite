...
$post_id    = $post->ID;
$fruit_slug = kaju_blog_get_post_fruit_slug( $post_id );
...
?>
<article class="c-log-card">
	<div class="c-log-card__inner">
		<a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>" class="c-log-card__permalink">
		...
		<div class="c-log-card__meta">
			<?php if ( $modifier && $label && '' !== $fruit_slug ) : ?>
				<a
					href="<?php echo esc_url( kaju_blog_record_filter_url( $fruit_slug ) ); ?>"
					class="c-log-card__meta-badge c-log-card__meta-badge--<?php echo esc_attr( $modifier ); ?>"
